...
public class TicketMasterAPI implements ExternalAPI{
	...
	private static final String API_KEY = "d365AmHnGLonaKMOqZWO261RkrHzp4PH";
	...
	public List<Item> search(double lat, double lon, String term) {
	 ...
	 //need to do url-encoding before adding it to http request. Browser should do it every time you type a url in address bar.
